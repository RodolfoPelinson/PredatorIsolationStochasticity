...
```{r}
absent_30<-as.incfreq(t(decostand(com_SS1[which(fish_isolation_SS1 == "1 030 absent"),], method = "pa")))
present_30<-as.incfreq(t(decostand(com_SS1[which(fish_isolation_SS1 == "1 030 present"),], method = "pa")))
absent_120<-as.incfreq(t(decostand(com_SS1[which(fish_isolation_SS1 == "1 120 absent"),], method = "pa")))
present_120<-as.incfreq(t(decostand(com_SS1[which(fish_isolation_SS1 == "1 120 present"),], method = "pa")))
absent_480<-as.incfreq(t(decostand(com_SS1[which(fish_isolation_SS1 == "1 480 absent"),], method = "pa")))
present_480<-as.incfreq(t(decostand(com_SS1[which(fish_isolation_SS1 == "1 480 present"),], method = "pa")))
