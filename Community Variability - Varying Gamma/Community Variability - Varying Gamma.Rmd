...
This is the same community variability analyses presented in the main paper, but here we are not keeping gamma diversity constant for each treatment. This is to show that Gamma diversity had little impact in the main patterns.
