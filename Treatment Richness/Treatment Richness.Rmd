...
#### First Survey
First we get the estimated total estimated number of species in each treatment for a sample size of four ponds.
...
```{r 4, dpi = 150, fig.height=4, fig.width=4}
...
We can plot the estimates and respective confidence intervals.
```{r 6, dpi = 150, fig.height=4, fig.width=4}
par(cex = 0.75, mar = c(4,4,1.5,0.1))
...
We can plot the estimates and respective confidence intervals.
```{r 8, dpi = 150, fig.height=4, fig.width=4}
par(cex = 0.75, mar = c(4,4,1.5,0.1))
...
It seems that there is a higher number of species in the intermediate isolation treatment for fishless ponds.
