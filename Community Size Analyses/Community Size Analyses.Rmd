...
Analysing the data:
```{r running models for abundance predators, cache=T}
...
Now pairwise differences:
```{r pairwise abundances predators, cache = T}
...
Lets plot it:
```{r Plotting effect of abundance predators, dpi = 150, fig.height=5, fig.width=5}
...
Analysing the data:
```{r running models for non predators abundance, cache=T}
...
Now pairwise differences:
```{r pairwise abundances non predators, cache = T}
...
Lets plot it:
```{r Plotting effect of abundance non predators, dpi = 150, fig.height=5, fig.width=5}
