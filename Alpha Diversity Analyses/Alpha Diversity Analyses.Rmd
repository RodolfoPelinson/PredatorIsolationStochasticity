...
Lets plot it:
```{r Plotting_ab_pr, dpi = 150, fig.height=5, fig.width=10}
...
Analysing the data:
```{r running_ab_pr, cache=T}
mix_model_non_predators_NB <- lmer(com_SS2_SS3_non_predators_richness~fish_SS2_SS3*isolation_SS2_SS3*SS_SS2_SS3 + (1|ID_SS2_SS3), control = lmerControl(optimizer = "bobyqa"))
